...
function Home() {
  ...
  return <main>
    ...
    <section className="about section" id="om-oss"><div className="about-image reveal"><img src="/images/about.jpg" alt="Städning med fokus på detaljer" width={900} height={850} loading="lazy" /></div><div className="about-copy reveal"><p className="eyebrow">OM MARIA M STÄD</p><h2>Städning du kan känna dig <em>trygg med.</em></h2><p>Maria M Städ har hjälpt kunder i Malmö sedan 2019. Vi tror att god service sitter i detaljerna: att komma i tid, lyssna på vad du behöver och lämna det riktigt rent efter oss.</p><div className="benefits"><div><b>Noggranna</b><span>Vi ser de små sakerna.</span></div><div><b>Personliga</b><span>En kontakt du kan lita på.</span></div><div><b>Flexibla</b><span>Tider och upplägg som passar.</span></div><div><b>Pålitliga</b><span>Trygg hjälp, varje gång.</span></div></div><Link to="/om" className="text-link">Läs mer om oss <span>→</span></Link></div></section>
