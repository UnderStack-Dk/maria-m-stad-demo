...
function AboutPage() {
  useScrollReveal([])
  return <main>
    <Seo title="Om oss | Maria M Städ" description="Maria M Städ har städat hem, kontor och studentrum i Malmö sedan 2019 med tydlig kommunikation och pålitlig service." path="/om" />
    <section className="page-hero reveal">
      <p className="eyebrow">OM MARIA M STÄD</p>
      <h1>Städning med <em>tydlig kommunikation.</em></h1>
      <p className="lead">Sedan vi öppnade 2019 har vi haft en enkel inställning: städning av högsta kvalité och tydlig kommunikation med varje kund — hela vägen.</p>
    </section>
    <section className="section about-story">
      ...
      <div className="about-story-values reveal">
        <div><b>Sedan 2019</b><span>Flera år av nöjda kunder i Malmö.</span></div>
